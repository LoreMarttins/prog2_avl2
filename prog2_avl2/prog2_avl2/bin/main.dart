 ...
 */
import "dart:io";
import "package:prog2_avl3/periodicTable.dart";
import "package:prog2_avl3/molecule.dart";
...
void showElements() {
  ...
  PeriodicTable.elements.forEach(
    (_, element) {
      final row =
          '${element.symbol}\t${element.name}\t${element.latinName}\t${element.weight}';
      printTabbed(row, tabs);
    },
  );
  line();
}
...
void main() {
  ...
  // Testa a criação de moléculas válidas
  final molecules = [
